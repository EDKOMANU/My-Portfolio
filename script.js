...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeDataVisualization(); // Add this line
});
...
function displayData(data) {
    ...
    // Create data cards
    data.dataset.dimension.Defaecatepoint.category.index.forEach((key, index) => {
        ...
        card.innerHTML = `
            ...
            <div class="data-card-body">
                <p>${data.dataset.dimension.Defaecatepoint.category.label}</p>
                <div class="data-stats">
                    <div class="stat-item">
                        <span class="stat-label">Index:</span>
                        <span class="stat-value">${index}</span>
                    </div>
                </div>
            </div>
        `;
    ...
    if (window.Chart && data.dataset.dimension.Defaecatepoint.category.index.length > 0) {
        createChart(data);
    }
}
...
function createChart(data) {
    ...
    const chartData = {
        labels: Object.keys(data.dataset.dimension.Defaecatepoint.category.index),
        datasets: [{
            label: 'Data Values',
            data: Object.values(data.dataset.dimension.Defaecatepoint.category.index),
